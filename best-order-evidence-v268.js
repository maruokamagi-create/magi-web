(()=>{
'use strict';
if(window.MAGI_BEST_ORDER_EVIDENCE_V268)return;
...
'現時点の基準案：1嶋田栄志、2大野竜暉、3坂田暉馬、4中嶋玲月、5大久保陽翔、6鰐渕将太、7橋向結都、8大久保夢翔、9吉田真翔。データ上の明確な理由がある場合のみ変更し、変更理由を示す。'
];
...
function install(){if(typeof window.searchDataEvidence!=='function')return false;if(window.searchDataEvidence.__bestOrderV268)return true;const prev=window.searchDataEvidence;window.searchDataEvidence=function(q){const base=prev(q);return isBestOrder(q)?build(q,base):base};window.searchDataEvidence.__bestOrderV268=true;window.MAGI_BEST_ORDER_EVIDENCE_V268=true;return true}
