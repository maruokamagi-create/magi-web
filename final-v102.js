(()=>{
  ...
  .final .title{display:block;padding:4px 0 4px 10px;border-left:3px solid #4db8d8;font-size:14px;letter-spacing:.12em;color:#f2f7fb;font-weight:900;line-height:1.35}
  ...
  .final.decision-yes{border-top-color:#20c779}.final.decision-yes .title{border-left-color:#20c779}.final.decision-yes .verdict{border-bottom-color:rgba(32,199,121,.55)}.final.decision-yes .verdict::before{content:'🟢 ◎'}
  .final.decision-cond{border-top-color:#2f86ff}.final.decision-cond .title{border-left-color:#2f86ff}.final.decision-cond .verdict{border-bottom-color:rgba(47,134,255,.58)}.final.decision-cond .verdict::before{content:'🔵 ○'}
  .final.decision-hold{border-top-color:#f2b91d}.final.decision-hold .title{border-left-color:#f2b91d}.final.decision-hold .verdict{border-bottom-color:rgba(242,185,29,.58)}.final.decision-hold .verdict::before{content:'🟡 △'}
  .final.decision-no{border-top-color:#e04452}.final.decision-no .title{border-left-color:#e04452}.final.decision-no .verdict{border-bottom-color:rgba(224,68,82,.58)}.final.decision-no .verdict::before{content:'🔴 ×'}
  @media(max-width:430px){.final{padding:19px 14px 18px}.final .verdict{font-size:29px;padding-bottom:8px}.final .verdict::before{font-size:.68em;margin-right:.3em}.final .title{font-size:13px;padding-left:9px}.final .vote{font-size:11px;padding:7px 9px}.final .note,.final .humanDecision{font-size:12px}}
  `;
