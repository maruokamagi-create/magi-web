(async()=>{
  const V='0.10.26', A='126';
  const extras=['/analysis-v093.js?v=126','/generic-v098.js?v=126','/batfix-v100.js?v=126','/role-v101.js?v=126','/pitch-v113.js?v=126','/final-v102.js?v=126','/final-detail-v103.js?v=126','/layout-v112.js?v=126'];
  ...
  const brand=()=>{
    ...
    if(!document.getElementById('magi-brand-v126-style')){
      const st=document.createElement('style');st.id='magi-brand-v126-style';
    ...
    lock.innerHTML='<img class="magiBrandSymbol" src="/magi-official-symbol-v125.svg?v=126" alt="MAGI 公式3色シンボル"><div class="magiBrandCopy"><div class="magiBrandEn">Maruoka Advanced Game Intelligence</div><div class="magiBrandCatch">知りたいことから、伝えたいことまで。</div></div>';
