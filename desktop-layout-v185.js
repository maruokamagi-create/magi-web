(()=>{
  ...
  @media(min-width:900px){
    .wrap{width:min(100%,1460px);max-width:none;padding:24px clamp(20px,2.4vw,40px) 72px}
    .hero{padding-left:8px;padding-right:8px}.hero .jp{font-size:17px}.hero p{font-size:15px;max-width:1040px}
    .statement{font-size:15px;padding:15px 18px}.section{margin-top:24px}.sectionHead h2{font-size:23px}
    .personaGrid,.flowGrid,.criteriaGrid,.hubGrid{gap:14px}.persona{padding:18px;min-height:190px}
    .persona p,.persona li{font-size:14px;line-height:1.75}.personaLead{font-size:14px!important;max-width:1120px}
    .flow{padding:17px}.flow h3{font-size:16px}.flow p{font-size:14px;line-height:1.7}
    ...
    .rulesText,.hubText,.driveHelp,.routeHelp,.advancedPanel p{font-size:14px}.hubTitle{font-size:17px}
    .dataState,.driveState{font-size:13px;padding:13px}label{font-size:15px}
    ...
    .answer .roleSmall,.answer .confidence{font-size:12px}.answer p{font-size:15px;line-height:1.85}
    .meta{gap:12px}.mini{padding:12px}.mini b{font-size:11px}.mini span{font-size:13px;line-height:1.7}
  ...
  @media(min-width:1500px){.wrap{width:min(100%,1540px)}}`;
