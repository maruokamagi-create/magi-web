...
function activateButton(){const b=findButton();if(!b)throw new Error('MAGI実行ボタンを取得できません');b.id='magiRunButton';b.type='button';b.dataset.magiEntry='semantic-v373';b.removeAttribute('onclick');b.disabled=false;b.textContent='MAGI実行';}
async function boot(){
  ...
  window.MAGI_APP_RUNTIME=Object.freeze({version:'canonical-app-v373',clientVersion:363,runtimeVersion:363,ready:true,entry:'WINDOW_CAPTURE_SEMANTIC_V2',formalRunner:'V373_SINGLE_PATH',progress:'EVENT_DRIVEN_ONLY',rawPacketValidated:true,numericFailClosed:true,structuredValidationOnly:true,proseBlocking:false,authoritativeEvidenceVisible:true,staleClientFailClosed:true,bootstrapLast:true,localFallback:false,engineVersion:String(window.MAGI_ENGINE_V1?.version||'')});
