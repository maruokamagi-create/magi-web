(async()=>{
  const V='0.10.24', A='124';
  const extras=['/magi-symbol-official-v123.js?v=124','/analysis-v093.js?v=124','/generic-v098.js?v=124','/batfix-v100.js?v=124','/role-v101.js?v=124','/pitch-v113.js?v=124','/final-v102.js?v=124','/final-detail-v103.js?v=124','/layout-v112.js?v=124'];
  ...
  const brand=()=>{
    ...
    if(!document.getElementById('magi-brand-v124-style')){
      const st=document.createElement('style');st.id='magi-brand-v124-style';
    ...
    const img=lock.querySelector('.magiBrandSymbol');img.src=window.MAGI_OFFICIAL_SYMBOL||'';row.appendChild(lock);
