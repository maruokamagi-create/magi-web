(()=>{
  ...
  `;
  for(const id of ['magi-layout-v104-style','magi-layout-v105-style','magi-layout-v106-style','magi-layout-v107-style','magi-layout-v108-style','magi-layout-v109-style']){const old=document.getElementById(id);if(old)old.remove()}
  const st=document.createElement('style');st.id='magi-layout-v110-style';st.textContent=css;document.head.appendChild(st);
