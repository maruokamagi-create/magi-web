(async()=>{
  ...
  const personaCopy=()=>{
    ...
    cards[2].innerHTML='<div class="personaTop"><div class="personaMeta"><div class="num">03 / CASPER</div><h3>カスパー</h3><div class="role">選手評価担当</div><span class="personaAxis">人とチームを見る</span></div><img class="personaPortrait" src="/assets/casper-latest.png?v=155" alt="CASPER"></div><p>数字だけでは見えない「人の状態」を担当します。成長、意欲、責任感、周囲との関係、役割の負担まで含め、短期の勝敗だけでなくチームが長く良くなるかを考えます。</p><ul><li>成長・意欲・責任感・自発性</li><li>声掛け・信頼・チーム内への影響</li><li>役割の偏りや負担、育成面の懸念</li></ul>';
  };
