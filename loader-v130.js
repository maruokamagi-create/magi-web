(async()=>{
  const V='0.10.63', A='168';
  const extras=['/analysis-v093.js?v=140','/generic-v098.js?v=140','/batfix-v100.js?v=140','/role-v101.js?v=140','/pitch-v113.js?v=140','/final-v102.js?v=140','/final-detail-v103.js?v=140','/layout-v112.js?v=140','/desktop-layout-v185.js?v=186','/engine/magi-engine-v1.js?v=187','/drive-evidence-v194.js?v=204','/engine-ui-v187.js?v=194'];
  ...
  const brand=()=>{
    ...
    if(!document.getElementById('magi-brand-v140-style')){
      const st=document.createElement('style');st.id='magi-brand-v140-style';
      st.textContent=`.magiTitleRow{display:flex;align-items:center;gap:8px;margin:8px 0 10px;min-width:0}.magiTitleRow .magiMainTitle{margin:0;flex:0 0 auto;line-height:1;font-size:42px;letter-spacing:.08em}.magiBrandLockup{display:flex;align-items:center;gap:6px;min-width:0}.magiBrandSymbol{width:54px;height:54px;display:block;flex:0 0 auto;object-fit:contain;image-rendering:auto}.magiBrandCopy{min-width:0;line-height:1.18}.magiBrandEn{font-size:11.5px;font-weight:600;color:#dbe7f4;white-space:nowrap}.magiBrandCatch{margin-top:4px;font-size:11px;font-weight:600;color:#dbe7f4;white-space:nowrap}.hero .jp{margin-top:2px}.hero p{line-height:1.5;margin-top:14px;margin-bottom:14px}.hero p.magiIntroRef{line-height:1.2}.personaLead{font-size:13px;line-height:1.55;color:#a9bdd0;margin:-2px 0 12px}.personaAxis{display:block;font-size:16px;font-weight:900;margin:2px 0 8px;color:#fff}.personaQuote{white-space:nowrap;margin-top:12px}.pBlue .personaAxis{color:#7eb0ff}.pRed .personaAxis{color:#ff7d8f}.pGreen .personaAxis{color:#67d39d}.persona h3{font-size:20px}.persona .role{font-size:14px}.persona p{margin-top:8px;margin-bottom:8px}.personaTop{display:flex;align-items:flex-start;justify-content:space-between;gap:8px;margin-bottom:8px}.personaMeta{min-width:0;flex:1 1 auto}.personaPortrait{display:block;width:154px;max-width:46%;height:auto;flex:0 0 auto;align-self:flex-start;margin:-20px -4px 0 0;object-fit:contain;object-position:center top;background:transparent;border:0;image-rendering:auto;filter:drop-shadow(0 8px 14px rgba(0,0,0,.28))}@media(max-width:430px){.magiTitleRow{gap:6px;margin:8px 0 10px}.magiTitleRow .magiMainTitle{font-size:34px;letter-spacing:.05em}.magiBrandLockup{gap:4px}.magiBrandSymbol{width:46px;height:46px}.magiBrandEn,.magiBrandCatch{font-size:8.7px;letter-spacing:-.015em}.magiBrandCatch{margin-top:3px}.hero p{line-height:1.5}.hero p.magiIntroRef{line-height:1.2}.personaLead{font-size:13px;line-height:1.55}.personaAxis{font-size:16px}.persona .role{font-size:14px}.persona h3{font-size:20px}.personaPortrait{width:154px;max-width:46%;margin:-20px -4px 0 0}}@media(min-width:431px) and (max-width:899px){.personaPortrait{width:180px;max-width:42%}}`;
    ...
    lock.innerHTML='<img class="magiBrandSymbol" src="/magi-official-symbol-v125.svg?v=140" alt="MAGI 公式3色シンボル"><div class="magiBrandCopy"><div class="magiBrandEn">Maruoka Advanced Game Intelligence</div><div class="magiBrandCatch">知りたいことから、伝えたいことまで。</div></div>';
  ...
  const personaCopy=()=>{
    ...
    cards[0].innerHTML='<div class="personaTop"><div class="personaMeta"><div class="num">01 / MELCHIOR</div><h3>メルキオール</h3><div class="role">データ解析担当</div><span class="personaAxis">事実を確かめる</span><span class="personaAxis personaQuote">「数字は嘘をつかない。」</span></div><img class="personaPortrait" src="/portraits/melchior.png?v=168" alt="MELCHIOR"></div><p>成績や記録、比較できる材料から「実際に何が起きているか」を整理します。感覚や印象より根拠を優先し、材料が足りない時は無理に断定しません。</p><ul><li>打率・OPS・投手成績などの数値確認</li><li>期間別・相手別・起用別の比較</li><li>「分かること／まだ分からないこと」の切り分け</li></ul>';
    cards[1].innerHTML='<div class="personaTop"><div class="personaMeta"><div class="num">02 / BALTHASAR</div><h3>バルタザール</h3><div class="role">戦術演算担当</div><span class="personaAxis">勝ち筋を組み立てる</span><span class="personaAxis personaQuote">「俺は、勝つ手を打つ。」</span></div><img class="personaPortrait" src="/portraits/balthasar.png?v=168" alt="BALTHASAR"></div><p>メルキオールが示した事実を材料に、「では、どう戦うか」を考えます。相手、点差、イニング、選手構成を見ながら、勝利につながる選択肢と切り替え条件を組み立てます。</p><ul><li>打順・守備位置・先発・継投・代打</li><li>相手や試合展開に応じた代替案</li><li>攻める／守る判断とリスク管理</li></ul>';
    cards[2].innerHTML='<div class="personaTop"><div class="personaMeta"><div class="num">03 / CASPER</div><h3>カスパー</h3><div class="role">選手評価担当</div><span class="personaAxis">人とチームを見る</span><span class="personaAxis personaQuote">「未来まで見ろ。」</span></div><img class="personaPortrait" src="/portraits/casper.png?v=168" alt="CASPER"></div><p>数字だけでは見えない「人の状態」を担当します。成長、意欲、責任感、周囲との関係、役割の負担まで含め、短期の勝敗だけでなくチームが長く良くなるかを考えます。</p><ul><li>成長・意欲・責任感・自発性</li><li>声掛け・信頼・チーム内への影響</li><li>役割の偏りや負担、育成面の懸念</li></ul>';
  };
