(async()=>{
  const V='0.10.29', A='129';
  const extras=['/analysis-v093.js?v=129','/generic-v098.js?v=129','/batfix-v100.js?v=129','/role-v101.js?v=129','/pitch-v113.js?v=129','/final-v102.js?v=129','/final-detail-v103.js?v=129','/layout-v112.js?v=129'];
  ...
  const brand=()=>{
    ...
    lock.innerHTML='<img class="magiBrandSymbol" src="/magi-official-symbol-v125.svg?v=129" alt="MAGI 公式3色シンボル"><div class="magiBrandCopy"><div class="magiBrandEn">Maruoka Advanced Game Intelligence</div><div class="magiBrandCatch">知りたいことから、伝えたいことまで。</div></div>';
