...
function rowText(st){
  return `<div class="magiLineupStatsLine"><span class="magiLineupStat magiLineupSeason">今季</span><span class="magiLineupStat">${fmt(st.games)}試合</span><span class="magiLineupStat">${fmt(st.PA)}打席</span><span class="magiLineupStat">${fmt(st.AB)}打数</span><span class="magiLineupStat">${fmt(st.H)}安打</span></div><div class="magiLineupStatsLine magiLineupRate"><span class="magiLineupStat">打率 <b>${fmt(st.AVG)}</b></span><span class="magiLineupStat">出塁率 <b>${fmt(st.OBP)}</b></span><span class="magiLineupStat">長打率 <b>${fmt(st.SLG)}</b></span><span class="magiLineupStat">OPS <b>${fmt(st.OPS)}</b></span></div><div class="magiLineupStatsLine magiLineupRate"><span class="magiLineupStat">得点圏打率 <b>${fmt(st.RISP)}</b></span><span class="magiLineupStat">${fmt(st.RBI)}打点</span><span class="magiLineupStat">四死球 ${fmt(st.BBHBP)}</span><span class="magiLineupStat">盗塁 ${fmt(st.SB)}</span></div>`;
}
