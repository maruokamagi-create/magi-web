(async()=>{
  const V='0.10.27', A='127';
  const extras=['/analysis-v093.js?v=127','/generic-v098.js?v=127','/batfix-v100.js?v=127','/role-v101.js?v=127','/pitch-v113.js?v=127','/final-v102.js?v=127','/final-detail-v103.js?v=127','/layout-v112.js?v=127'];
  ...
  const brand=()=>{
    ...
    lock.innerHTML='<img class="magiBrandSymbol" src="/magi-official-symbol-v125.svg?v=127" alt="MAGI 公式3色シンボル"><div class="magiBrandCopy"><div class="magiBrandEn">Maruoka Advanced Game Intelligence</div><div class="magiBrandCatch">知りたいことから、伝えたいことまで。</div></div>';
