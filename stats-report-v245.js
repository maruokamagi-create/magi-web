(()=>{
'use strict';
if(window.MAGI_STATS_REPORT_V245)return;
const VERSION='v245';
...
function installStyles(){
 if(document.getElementById('magi-stats-report-v245-style'))return;
...
window.MAGI_STATS_REPORT_V245=true;
