(()=>{
  ...
  const STYLE_ID='magi-criteria-v280-style';
  ...
  const ensureStyle=()=>{
    ...
    style.textContent=`
      ...
      @media(max-width:520px){
        .magiCriteriaSection .rulesPanel{padding:11px!important}
        .magiCriteriaSection .criteriaGrid{gap:9px!important}
        .magiCriteriaSection .magiJudgeInner{grid-template-columns:1fr!important;min-height:0!important}
        .magiCriteriaSection .magiJudgeMain{padding:14px 14px 8px!important;gap:12px!important}
        .magiCriteriaSection .magiJudgeSymbol{width:52px!important;min-width:52px!important;height:52px!important;font-size:41px!important}
        .magiCriteriaSection .magiJudgeName{font-size:20px!important}
        .magiCriteriaSection .magiJudgeCopy{padding:7px 14px 14px 78px!important;border-left:0!important}
        .magiCriteriaSection .magiJudgeCopy b{font-size:15px!important;margin-bottom:3px!important}
        .magiCriteriaSection .magiJudgeCopy span{font-size:12.5px!important}
        .magiCriteriaSection .magiCriteriaNote{font-size:11.5px!important}
      }
    `;
  ...
  const apply=()=>{
    ...
    grid.innerHTML=`
      <div class="criteria cYes">
        <div class="magiJudgeInner">
          <div class="magiJudgeMain"><div class="magiJudgeSymbol">◎</div><div class="magiJudgeName">賛成</div></div>
          <div class="magiJudgeCopy"><b>積極的に推奨</b><span>最も前向きな判断です。</span></div>
        </div>
      </div>
      <div class="criteria cCond">
        <div class="magiJudgeInner">
          <div class="magiJudgeMain"><div class="magiJudgeSymbol">○</div><div class="magiJudgeName">条件付き賛成</div></div>
          <div class="magiJudgeCopy"><b>条件が整えば推奨</b><span>条件や状況次第で前向きに判断します。</span></div>
        </div>
      </div>
      <div class="criteria cHold">
        <div class="magiJudgeInner">
          <div class="magiJudgeMain"><div class="magiJudgeSymbol">△</div><div class="magiJudgeName">判断保留</div></div>
          <div class="magiJudgeCopy"><b>情報不足・再検証</b><span>現時点では判断せず、追加情報や再検証を行います。</span></div>
        </div>
      </div>
      <div class="criteria cNo">
        <div class="magiJudgeInner">
          <div class="magiJudgeMain"><div class="magiJudgeSymbol">✕</div><div class="magiJudgeName">反対</div></div>
          <div class="magiJudgeCopy"><b>現時点では非推奨</b><span>リスクや課題が大きく、推奨できない判断です。</span></div>
        </div>
      </div>`;
    ...
    if(panel){
      ...
      if(!note){
        ...
        note.className='magiCriteriaNote';
      ...
      panel.querySelectorAll('.rulesText').forEach(el=>{
        if(el!==note && /◎.*○|賛成票|反対意見/.test(el.textContent||'')) el.style.display='none';
      });
    }
