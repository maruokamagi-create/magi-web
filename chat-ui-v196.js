...
.magiBubble{position:relative;background:#fff;border-radius:4px 16px 16px 16px;padding:11px 13px;font-size:14px;line-height:1.72;color:#16283a;box-shadow:0 1px 2px rgba(0,0,0,.08);word-break:break-word}.magiMsg.mel .magiBubble{border-left:4px solid #16945c}.magiMsg.bal .magiBubble{border-left:4px solid #c52b38}.magiMsg.cas .magiBubble{border-left:4px solid #1e4f96}
.magiJudgeTag{display:inline-block;margin:8px 0 0;font-size:9px;font-weight:900;border-radius:999px;padding:3px 7px;background:#eef3f7;color:#4a6075}.magiMsg.mel .magiJudgeTag{color:#13724a}.magiMsg.bal .magiJudgeTag{color:#a6222f}.magiMsg.cas .magiJudgeTag{color:#204f8e}
