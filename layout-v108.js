(()=>{
  ...
  .answer .voteIcon{width:30px;height:30px;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;color:#fff;font-size:17px;font-weight:950;line-height:1;border:0;box-shadow:0 2px 5px rgba(0,0,0,.20)}
  ...
  `;
  for(const id of ['magi-layout-v104-style','magi-layout-v105-style','magi-layout-v106-style','magi-layout-v107-style']){const old=document.getElementById(id);if(old)old.remove()}
  const st=document.createElement('style');st.id='magi-layout-v108-style';st.textContent=css;document.head.appendChild(st);
