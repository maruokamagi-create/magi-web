(()=>{
  ...
  const ensureStyle=()=>{
    if(document.getElementById('magi-test-brand-v276-style')) return;
    const style=document.createElement('style');
    style.id='magi-test-brand-v276-style';
    style.textContent=`
      .hero .kicker{
      ...
      .hero .magiEnvLabel{white-space:nowrap!important;flex:0 1 auto}
      .hero .free{
