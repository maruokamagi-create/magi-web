(()=>{
'use strict';
if(window.MAGI_PITCH_REPORT_V253)return;
const VERSION='v253';
...
function render(result){
 ...
 const query=(document.getElementById('q')?.value||'').trim();try{if(typeof FINAL!=='undefined')FINAL.lookup='成績照会';if(query&&typeof saveHistory==='function')saveHistory(query,'lookup')}catch(e){}
...
window.MAGI_PITCH_REPORT_V253=true;
